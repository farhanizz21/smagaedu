<div class="max-w-2xl mx-auto px-6 py-8">
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Reset Password</h1>
        <p class="text-gray-500 mt-1 text-sm">Reset password untuk user:
            <strong><?= isset($target_user->nama) ? $target_user->nama : '' ?></strong>
        </p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-8">
        <form action="" method="post" class="space-y-6">
            ...
            <!-- Submit Button -->
            <button type="submit"
                class="w-full py-3.5 rounded-2xl font-bold text-white bg-red-600 hover:bg-red-700 active:bg-red-800 shadow-lg shadow-red-200 hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2">
