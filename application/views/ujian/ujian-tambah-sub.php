    ...
    <div
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight text-white">Tambah Ujian Sub Bab</h1>
                    <p class="text-rose-100 text-sm mt-1">
                        Materi: <span class="font-semibold"><?= $materi->judul ?></span> →
                        Bab: <span class="font-semibold"><?= $bab->judul ?></span> →
                        Sub Bab: <span class="font-semibold"><?= $sub->judul ?></span>
                    </p>
                </div>
            </div>
        </div>
