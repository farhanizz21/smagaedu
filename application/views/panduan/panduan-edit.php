    ...
    <div
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight text-white">Edit Data Panduan</h1>
                    <p class="text-amber-100 text-sm mt-1">Perbarui informasi panduan yang sudah ada</p>
                </div>
            </div>
        </div>
