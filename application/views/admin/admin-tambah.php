...
<?php $this->load->view('partials/header_tailwind', ['title' => 'Tambah Admin']); ?>
...
<div class="max-w-4xl mx-auto px-6 py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <div class="flex items-center gap-3 mb-1">
                <a href="<?= base_url('admin/admins')?>" class="text-gray-400 hover:text-gray-600 transition-colors">
                    <i data-lucide="arrow-left" class="w-5 h-5"></i>
                </a>
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Data Admin</h1>
            </div>
            <p class="text-gray-500 text-sm ml-8">Lengkapi formulir di bawah untuk menambahkan admin baru</p>
        </div>
    </div>
    ...
    <div class="mb-6 p-4 rounded-xl bg-blue-50 border border-blue-200 text-blue-700 text-sm flex items-center gap-2">
        ...
        Password default untuk admin baru: <strong>admin12345</strong>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 table-shadow">
        <form method="post" action="<?= base_url('admin/admins_tambah');?>">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="email" name="email"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-sm placeholder:text-gray-400"
                        placeholder="admin@sekolah.sch.id" value="<?= set_value('email'); ?>">
