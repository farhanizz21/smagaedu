...
<?php $this->load->view('partials/header_tailwind', ['title' => 'Edit Kepala Sekolah']); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <div class="flex items-center gap-3 mb-1">
                ...
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Edit Kepala Sekolah</h1>
            </div>
            <p class="text-gray-500 text-sm ml-8">Edit data akun kepala sekolah</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 table-shadow">
        <form method="post" action="<?= base_url('admin/kepala_sekolah_edit/'.$kepsek->uuid);?>">
            <input type="hidden" name="uuid" value="<?= $kepsek->uuid; ?>">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="namaLengkap" id="namaLengkap"
                        ...
                        placeholder="Masukkan Nama Lengkap" value="<?= set_value('namaLengkap', $kepsek->nama); ?>">
                ...
                <div>
                    ...
                    <input type="text" name="username" id="username"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-sm placeholder:text-gray-400"
                        placeholder="Masukkan Username" value="<?= set_value('username', $kepsek->username); ?>">
                ...
                <div>
                    ...
                    <input type="email" name="email"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-sm placeholder:text-gray-400"
                        placeholder="Masukkan Email" value="<?= set_value('email', $kepsek->email); ?>">
