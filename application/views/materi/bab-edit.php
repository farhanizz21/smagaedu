...
<div class="max-w-3xl mx-auto px-6 py-8">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 table-shadow">
        <?= form_open_multipart('bab/edit/' . $bab->uuid); ?>
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="judul" id="judul"
                    ...
                    placeholder="Masukkan Judul Bab" value="<?= set_value('judul', $bab->judul); ?>">
            ...
            <div>
                ...
                <div id="editor" style="height: 200px;"><?= set_value('deskripsi', $bab->deskripsi); ?></div>
                <input type="hidden" name="deskripsi" id="deskripsi"
                    value="<?= set_value('deskripsi', $bab->deskripsi); ?>">
