...
<?php $this->load->view('partials/header_tailwind', ['title' => 'Tambah Sub Bab']); ?>
...
<div class="max-w-3xl mx-auto px-6 py-8">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 table-shadow">
        <?= form_open_multipart('sub_materi/tambah/' . $bab->uuid); ?>
        <div class="space-y-6">
            <div>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Upload File <span
                        class="text-red-500">*</span></label>
