...
<?php $this->load->view('partials/header_tailwind', ['title' => 'Tambah Mata Pelajaran']); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <div class="flex items-center gap-3 mb-1">
                ...
                <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Data Mata Pelajaran
                </h1>
            </div>
            <p class="text-gray-500 text-sm ml-8">Lengkapi formulir di bawah untuk menambahkan mata pelajaran baru</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 table-shadow">
        <form method="post" action="<?= base_url('mapel/tambah');?>">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="namaMapel" id="namaMapel"
                        ...
                        placeholder="Masukkan Nama Mata Pelajaran" value="<?= set_value('namaMapel'); ?>">
