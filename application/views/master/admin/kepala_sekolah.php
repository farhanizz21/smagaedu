...
<?php $this->load->view('partials/header_tailwind', ['title' => 'Data Kepala Sekolah']); ?>
...
<div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden table-shadow">
                    ...
                    <tr class="table-row-hover transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2">
                                <a href="<?=base_url('admin/kepala_sekolah_edit/'.$val->uuid)?>"
                                ...
                                <a href="<?=base_url('admin/kepala_sekolah_hapus/'.$val->uuid)?>"
        ...
        <div class="text-center py-12 text-gray-400">
            ...
            <p class="text-sm">Belum ada data kepala sekolah</p>
        </div>
        <?php endif; ?>
    </div>
</div>
